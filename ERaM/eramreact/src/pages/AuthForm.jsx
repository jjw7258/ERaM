				...
				<div className={styles.overlayContainer}>
					<div className={styles.overlay}>
						<div className={`${styles.overlayPanel} ${styles.overlayLeft}`}>
							...
							<button className={styles.ghost} id="signIn" onClick={() => toggleForm(false)} type="button">
								Sign In
							</button>
						</div>
						<div className={`${styles.overlayPanel} ${styles.overlayRight}`}>
							...
							<button className={styles.ghost} id="signUp" onClick={() => toggleForm(true)} type="button">
								Sign Up
							</button>
						</div>
					</div>
